...
"""Templates used in the original OpenAI CLIP paper."""

from ._template import Template

# taken from https://github.com/openai/CLIP/blob/main/data/prompts.md

BIRDSNAP_TEMPLATES: list[Template] = [lambda c: f"a photo of a {c}, a type of bird."]
"""Templates used in the original OpenAI CLIP paper for the Birdsnap dataset."""

CIFAR10_TEMPLATES: list[Template] = [
...
"""Templates used in the original OpenAI CLIP paper for the CIFAR-10 dataset."""

CIFAR100_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a blurry photo of a {c}.",
    lambda c: f"a black and white photo of a {c}.",
    lambda c: f"a low contrast photo of a {c}.",
...
"""Templates used in the original OpenAI CLIP paper for the CIFAR-100 dataset."""

CLEVR_COUNTS_TEMPLATES: list[Template] = [lambda c: f"a photo of {c} objects."]
"""Templates used in the original OpenAI CLIP paper for the CLEVR Counts dataset."""

CALTECH101_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}.",
...
COUNTRY211_TEMPLATES: list[Template] = [
...
"""Templates used in the original OpenAI CLIP paper for the Country211 dataset."""

DESCRIBABLE_TEXTURES_TEMPLATES: list[Template] = [
...
"""Templates used in the original OpenAI CLIP paper for the Describable Textures dataset."""  # noqa: E501

FGVC_AIRCRAFT_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}, a type of aircraft.",
    lambda c: f"a photo of the {c}, a type of aircraft.",
]
"""Templates used in the original OpenAI CLIP paper for the FGVC-Aircraft dataset."""

FER2013_TEMPLATES: list[Template] = [
...
"""Templates used in the original OpenAI CLIP paper for the Facial Emotion Recognition 2013 dataset."""  # noqa: E501

FLOWERS102_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}, a type of flower."
]
"""Templates used in the original OpenAI CLIP paper for the Flowers-102 dataset."""

FOOD101_TEMPLATES: list[Template] = [lambda c: f"a photo of {c}, a type of food."]
"""Templates used in the original OpenAI CLIP paper for the Food-101 dataset."""

GTRSB_TEMPLATES: list[Template] = [
    lambda c: f'a zoomed in photo of alambda c: f"{c}" traffic sign.',
    lambda c: f'a centered photo of alambda c: f"{c}" traffic sign.',
    lambda c: f'a close up photo of alambda c: f"{c}" traffic sign.',
]
"""Templates used in the original OpenAI CLIP paper for the German Traffic Sign Benchmark dataset."""  # noqa: E501

HATEFUL_MEMES_TEMPLATES: list[Template] = [lambda c: f"a {c}"]
"""Templates used in the original OpenAI CLIP paper for the Hateful Memes dataset."""

KITTI_TEMPLATES: list[Template] = [lambda c: c]
"""Templates used in the original OpenAI CLIP paper for the KITTI dataset."""

KINETICS700_TEMPLATES: list[Template] = [
    ...
    lambda c: f"a demonstration of {c}.",
...
"""Templates used in the original OpenAI CLIP paper for the Kinetics-700 dataset."""

MNIST_TEMPLAES: list[Template] = [lambda c: f"a photo of the number: {c}."]
"""Templates used in the original OpenAI CLIP paper for the MNIST dataset."""

OXFORD_IIIT_PET_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}, a type of pet."
]
"""Templates used in the original OpenAI CLIP paper for the Oxford-IIIT Pet dataset."""

PASCAL_VOC_2007_TEMPLATES: list[Template] = [lambda c: f"a photo of a {c}"]
"""Templates used in the original OpenAI CLIP paper for the PASCAL VOC 2007 dataset."""

PATCH_CAMELYON_TEMPLATES: list[Template] = [lambda c: f"this is a photo of {c}"]
"""Templates used in the original OpenAI CLIP paper for the Patch Camelyon dataset."""

RESISC45_TEMPLATES: list[Template] = [
...
"""Templates used in the original OpenAI CLIP paper for the RESISC45 dataset."""

SST2_TEMPLATES: list[Template] = [lambda c: f"a {c} review of a movie."]
"""Templates used in the original OpenAI CLIP paper for the SST-2 dataset."""

STL10_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
]
"""Templates used in the original OpenAI CLIP paper for the STL-10 dataset."""

SUN397_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
]
"""Templates used in the original OpenAI CLIP paper for the SUN397 dataset."""

STANFORD_CARS_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
...
"""Templates used in the original OpenAI CLIP paper for the Stanford Cars dataset."""

UCF101_TEMPLATES: list[Template] = [
    lambda c: f"a photo of a person{c}.",
    lambda c: f"a video of a person{c}.",
    lambda c: f"a example of a person{c}.",
    lambda c: f"a demonstration of a person{c}.",
...
"""Templates used in the original OpenAI CLIP paper for the UCF101 dataset."""

# taken from https://github.com/mlfoundations/wise-ft/blob/master/src/templates/openai_imagenet_template.py
IMAGENET_TEMPLATES: list[Template] = [
    lambda c: f"a bad photo of a {c}.",
...
"""Templates used in the original OpenAI CLIP paper for the ImageNet dataset."""
...
"""Classes used in the original OpenAI CLIP paper for the ImageNet dataset."""
