...
_FOLDER_NAME = "eurosat"
_IMAGES_URL = "https://zenodo.org/records/7711810/files/EuroSAT_RGB.zip"
_METADATA_URL = "https://raw.githubusercontent.com/vturrisi/disef/refs/heads/main/fine-tune/artifacts/eurosat/metadata.csv"
_LABELS_URL = "https://raw.githubusercontent.com/vturrisi/disef/refs/heads/main/fine-tune/artifacts/eurosat/split_coop.csv"


class EuroSATDataset(ClassificationDataset):
    """The EuroSAT dataset for image classification."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initializes the EuroSAT dataset.
    ...
    def download(cls, root: os.PathLike[str] | str, *, force: bool = False) -> None:
        ...
        images = root / "EuroSAT_RGB"
        images.rename(root / "images")
